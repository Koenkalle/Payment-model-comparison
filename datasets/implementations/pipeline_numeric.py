...
def numeric_payments(dataset):
    ...
    return NumericDataset(
        ...
        {
            **dataset.provenance,
            "numeric_conversion": "causal-payments/v1",
            "feature_history": "strictly-earlier-payment-timestamps",
            "outcomes_used": False,
        },
    )
...
def load(config, base):
    ...
    if view == "labeled_graph":
        ...
        return labeled_payments(
            dataset, {"node_feature_dim": config.get("node_feature_dim", 32)}
        )
