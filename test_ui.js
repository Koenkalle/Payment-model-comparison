...
const elements={},template=fs.readFileSync(__dirname+'/template.html','utf8');
...
for(const file of['d3.min.js','model-adapters.js','policy.js','model.js','scenarios.js','comparison.js','ui.js'])vm.runInContext(fs.readFileSync(__dirname+'/'+file,'utf8'),context,{filename:file});
async function run(){
