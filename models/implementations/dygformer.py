"""DyGFormer from TAMI/DyGLib; see UPSTREAM.md and licenses/.

Local adaptations: package imports and float64 timestamp padding.
"""
import numpy as np
import torch
...
class DyGFormer(nn.Module):
    ...
    def pad_sequences(self, node_ids: np.ndarray, node_interact_times: np.ndarray, nodes_neighbor_ids_list: list, nodes_edge_ids_list: list,
        ...
        padded_nodes_neighbor_times = np.zeros((len(node_ids), max_seq_length), dtype=np.float64)
