...
class Model(NeuralModel):
    architecture={'id': 'gru_attention', 'label': 'GRU + graph attention', 'hidden': 8, 'memory': 'gru', 'readout': 'attention', 'layers': 2, 'description': 'Original design: GRU account memory plus two layers of learned temporal graph attention.'}
