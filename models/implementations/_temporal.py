...
def sequence_payload(a,design):
    ...
    variant=DESIGNS[design]['variant'];cfg=dict(load_module(model_entry(design)['python_module']).CONFIG);cfg.update({'dim':8,'pair_dim':4,'history_limit':8,'pair_limit':6,'neighbor_limit':4,'gnn_layers':2,'history_decay':720.0,'pair_decay':1440.0,'pair_amount_weight':1.5,'pair_gap_weight':1.5,'histogram_smoothing':.5})
